...
namespace LibSM64
{
    public class SM64Types
    {
        ...
        {
            new(0x00, 0x00, 0x7f, 0xff),
            new(0x00, 0x00, 0xff, 0xff),
            new(0x7f, 0x00, 0x00, 0xff),
            new(0xff, 0x00, 0x00, 0xff),
            new(0x7f, 0x7f, 0x7f, 0xff),
            new(0xff, 0xff, 0xff, 0xff),
            new(0x39, 0x0e, 0x07, 0xff),
            new(0x72, 0x1c, 0x0e, 0xff),
            new(0x7f, 0x60, 0x3c, 0xff),
            new(0xfe, 0xc1, 0x79, 0xff),
            new(0x39, 0x03, 0x00, 0xff),
            new(0x73, 0x06, 0x00, 0xff),
        };
    }
